...
# player_page_url = raw_input("enter link to player's game log: ")
player_page_url = 'http://www.espn.com/nba/player/gamelog/_/id/3102530/year/2017/jusuf-nurki' # TODO: change the url to be generic
